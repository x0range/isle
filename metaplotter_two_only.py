...
def read_data():
    ...
    all_filenames = filenames_twos #filenames_ones + filenames_twos + filenames_threes + filenames_fours
...
def plotting(output_label, timeseries_dict, riskmodelsetting1, riskmodelsetting2, series1, series2=None, additionalriskmodelsetting3=None, additionalriskmodelsetting4=None, plottype1="mean", plottype2="mean"):
    ...
    outputfilename = "data/" + output_label + "_two_only.pdf"
...
plotting(output_label="fig_contracts_survival_1_2", timeseries_dict=timeseries, riskmodelsetting1="two", \
    riskmodelsetting2=None, series1="contracts", series2="operational", plottype1="mean", plottype2="median")
plotting(output_label="fig_reinsurers_contracts_survival_1_2", timeseries_dict=timeseries, riskmodelsetting1="two", \
    riskmodelsetting2=None, series1="reincontracts", series2="reinoperational", plottype1="mean", plottype2="median")
plotting(output_label="fig_premium_1_2", timeseries_dict=timeseries, riskmodelsetting1="two", riskmodelsetting2=None, \
